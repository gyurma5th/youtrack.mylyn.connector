 ...
 * @since 3.7
 */
public class InPlaceResizableCheckBoxTreeDialog extends AbstractInPlaceDialog {
  ...
  public InPlaceResizableCheckBoxTreeDialog(Shell shell, Control openControl, List<String> values,
  ...
  protected Control createControl(Composite parent) {
    ...
    valueTree =
        new CheckboxFilteredTree(composite, SWT.CHECK | SWT.MULTI | SWT.V_SCROLL | SWT.BORDER,
